...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-[#fe6d3c] dark:bg-neutral-800 w-[300px] shrink-0 ",
          className
        )}
        animate={{
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 bg-[#fe6d3c] dark:bg-neutral-900 p-10 z-[100] flex flex-col justify-between rounded-r-2xl",
                className
              )}>
              <div
