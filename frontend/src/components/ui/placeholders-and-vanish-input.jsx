...
export function PlaceholdersAndVanishInput({
  ...
  const handleSubmit = (e) => {
    ...
    vanishAndSubmit();
    if (searchValue) {
      navigate(`/destination?search=${encodeURIComponent(searchValue)}`);
    }
    onSubmit && onSubmit(e);
  };
  return (
    <form
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm font-medium sm:text-base z-50 border-none dark:text-white bg-transparent text-gray-800 placeholder:text-white h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20 ",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="dark:text-zinc-400 text-sm sm:text-lg font-normal text-neutral-900 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate">
