...
const HeroSection = () => {
  return (
    <section 
      className="bg-cover bg-center bg-no-repeat relative h-[90vh] mx-0 md:mx-4 lg:mx-8 rounded-none md:rounded-2xl flex items-center mt-20 p-4 "
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-0 lg:gap-12">
          ...
          <div className="space-y-6 md:space-y-8 items-center text-center lg:text-left  mt-10 lg:mt-0">
            <div className="space-y-4 md:space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-poppins font-bold text-white/90 leading-tight text-shadow-lg ">
                Explore 
                <div className="mt-2"> 
                   <span className=''>Incredible</span> India
                </div>
              </h1>
              <p className="font-inter text-sm sm:text-base md:text-lg lg:text-xl font-normal leading-relaxed text-gray-100 tracking-widest max-w-xl mx-auto lg:mx-0">
